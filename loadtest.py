...
def readTestCasesFromDB():
	...
	cur.close()
	conn.close()
	fileContent = fileContent +'<form action="/ExecuteTestCase?TestCaseId='+testcaseid+'" method="post" enctype="multipart/form-data"><input type="text" name="numberofcalls" value="Number of calls"><input type="submit" value="Execute Test Case" name="submit"></form></body></html>'
	return fileContent
