...
def readTestCasesFromDB():
	...
	cur.close()
	conn.close()
	fileContent = fileContent +'<form action="/ExecuteTestCase?TestCaseId='+testcaseid+'" method="post" enctype="multipart/form-data"><input type="text" name="numberofcalls" value="Enter number of calls to generate here "><input type="submit" value="Execute Test Case" name="submit"></form></body></html>'
	return fileContent
